...
tput cup 6 30
echo -e "\x1b[42m TECH WIZARD by ITZNIK \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Have you subscribe my channel TECH WIZARD for more hacking videos (y/n)? \e[m "
read answer
...
tput cup 20 0
figlet -f slant "TECH WIZARD by ITZNIK" |lolcat
echo " "
echo " "
